...
public class MarkdownTests
{
	...
	{
		var project = new MetalsharpProject(new MetalsharpConfiguration() { Verbosity = LogLevel.None }).AddInput("Scenario\\Plugins\\FileMarkdown.md").UseMarkdown();
	...
	{
		var project = new MetalsharpProject(new MetalsharpConfiguration() { Verbosity = LogLevel.None }).AddInput("Scenario\\Plugins\\FileMarkdown.md")
